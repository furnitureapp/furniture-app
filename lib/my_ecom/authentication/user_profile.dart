              ...
              child: isTablet(context)
                  ...
                  : Column(
                      children: [
                        ...
                        _buildInfoTile(),
                        _buildNavigationCard(context, "My Orders", Icons.shopping_bag, const OrderListPage()),
                        _buildNavigationCard(context, "Notifications", Icons.notifications, const NotificationScreen()),
                        _buildNavigationCard(context, "Liked Items", Icons.favorite, const FavoritesPage()),
                        SizedBox(
                          width: isTablet(context) ? MediaQuery.of(context).size.width / 2 - 32 : double.infinity,
                          child: _buildLogoutCard(context),
                        ),
                      ],
                    ),
                  ...
                  Stack(
                    ...
                    children: [
                      CircleAvatar(
                        ...
                        backgroundColor: const Color.fromARGB(255, 193, 177, 186),
                        child: Icon(
                          Icons.person,
                      ...
                      GestureDetector(
                        onTap: () {
                          if (fullUserData != null) {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (_) => EditUserProfilePage(userData: fullUserData!),
                              ),
                            ).then((_) {
                        ...
                        child: CircleAvatar(
                          ...
                          backgroundColor: const Color.fromARGB(255, 64, 152, 189),
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text("Hey!", style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.black)),
                ...
                Row(
                  ...
                  children: [
                    ElevatedButton(
                      ...
                      child: const Text("No", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.black)),
                    ),
                    ElevatedButton(
                      onPressed: () {
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: const Color.fromARGB(255, 241, 113, 104),
                        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
                        padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 12),
                      ),
                      child: const Text("Yes", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.white)),
                    ),
                  ],
                ),
              ],
...
//     setState(() {
//       fullUserData = data; // <-- store ENTIRE user object
//       companyName = data["companyName"];
//       userName = data["username"];
//       userEmail = data["email"];
//       userPhone = data["phoneNumber"];
...
//       backgroundColor: Colors.white,
//       appBar: PreferredSize(
//         preferredSize: Size.fromHeight(isTablet ? 250 : 300),
...
//                       MaterialPageRoute(
//                         builder: (_) =>
//                             EditUserProfilePage(userData: fullUserData!),
//                       ),
//                     ).then((_) {
...
//                     backgroundColor: Color.fromARGB(255, 64, 152, 189),
//                     child: Icon(Icons.edit_note, size: 22, color: Colors.white),
//                   ),
//                 ),
//               ],
//             ),
...
//         children: [
//           _infoTile(),
//           _navTile("My Orders", Icons.shopping_bag, const OrderListPage()),
//           _navTile(
//             "Notifications",
//             Icons.notifications,
//             const NotificationScreen(),
//           ),
//           _navTile("Liked Items", Icons.favorite, const FavoritesPage()),
//           _logoutTile(),
//         ],
//       ),
//     );
...
//     return ListTile(title: Text(title), trailing: Text(value ?? "N/A"));
//   }
