...
class _EditUserDialogState extends State<EditUserDialog> {
  ...
  late TextEditingController _dealernameController;
  ...
  void initState() {
    super.initState();
    _dealernameController = TextEditingController(text: widget.dealername);
  ...
  String? _validatedealername(String value) {
    if (value.isEmpty) return "dealername is required";
    if (value.length < 3) return "dealername too short (min 3 chars)";
    return null;
  }
  ...
  void _submitForm() {
    ...
    widget.onUpdate(
      updateddealername: _dealernameController.text.trim(),
...
//     if (value.length < 3) return "Dealer name must be at least 3 characters";
//     return null;
//   }
...
//   String? _validateStreetName(String value) {
//     if (value.isEmpty) return "Street name is required";
//     if (value.length < 4) return "Enter a valid street name";
//     return null;
//   }
...
//   String? _validateState(String value) {
//     if (value.isEmpty) return "State is required";
//     if (value.length < 3) return "Enter a valid state";
//     return null;
//   }
...
//           ),
//           focusedBorder: const UnderlineInputBorder(
//             borderSide: BorderSide(color: mythemecolor1, width: 3),
//           ),
//           errorStyle: const TextStyle(
//             color: Colors.red,
//             fontSize: 12,
