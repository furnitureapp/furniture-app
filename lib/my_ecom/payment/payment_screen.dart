...
class _PaymentScreenState extends State<PaymentScreen>
  ...
  Future<void> _startPayment() async {
    ...
    try {
      ...
      debugPrint('Payment Request Body: ${jsonEncode(requestBody)}');
      ...
      final razorpayOrderId = response['razorpayOrderId'];
final keyId = response['keyId'] ?? 'rzp_test_w5BdYCzO09lwRx';
...
_razorpay.open(options);
      ...
      showTopSnackBar(context, 'Payment initiation failed: $e');
    }
  }
          ...
          child: FadeTransition(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  Lottie.asset('assets/json/pay.json', height: 220),
                  ...
                  Text('Total Amount: ₹${widget.totalAmount.round()}',
                      style: GoogleFonts.poppins(
                    ...
                    Column(
                      children: [
                        ...
                        Text(
                          ...
                          style: GoogleFonts.poppins(
                              fontSize: 16, color: Colors.blue.withOpacity(0.8)),
                        ),
                        const SizedBox(height: 30),
                      ],
                    ),
