...
import 'package:furniture_ecom_app/my_ecom/register_dealer.dart';
...
class DealerGstVerificationPage extends StatefulWidget {
  ...
  @override
  State<DealerGstVerificationPage> createState() => _DealerGstVerificationPageState();
}

class _DealerGstVerificationPageState extends State<DealerGstVerificationPage> {
  ...
  Future<void> verifyGst() async {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => DealerRegistrationPage(gstNumber: gstModel.gstin),
      ),
    );
  }
