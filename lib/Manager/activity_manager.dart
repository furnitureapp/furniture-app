...
import 'package:furniture_ecom_app/administration_app/manager_app/manager_home.dart' hide isTablet;
...
class ManagerActivitylog extends StatefulWidget {
  const ManagerActivitylog({super.key});

  @override
  State<ManagerActivitylog> createState() => _ManagerActivitylogState();
}

class _ManagerActivitylogState extends State<ManagerActivitylog> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      drawer: const ManagerDrawer(currentPage: "Activity Log"),
