...
class TotalUsersM extends StatefulWidget {
  const TotalUsersM({super.key});

  @override
  State<TotalUsersM> createState() => _TotalUsersMState();
}

class _TotalUsersMState extends State<TotalUsersM> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      drawer: const ManagerDrawer(currentPage: "Dealers Management"),
