...
class TotalAdminM extends StatefulWidget {
  const TotalAdminM({super.key});

  @override
  State<TotalAdminM> createState() => _TotalAdminMState();
}

class _TotalAdminMState extends State<TotalAdminM> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer: ManagerDrawer(currentPage: "Admin Management"),
