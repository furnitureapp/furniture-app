...
import 'package:furniture_ecom_app/admin/activity_admin.dart';
import 'package:furniture_ecom_app/admin/admin_app_preveiw.dart';
import 'package:furniture_ecom_app/admin/approval_pie_ad.dart';
import 'package:furniture_ecom_app/admin/dealers_list.dart';
...
class AdminHomes extends StatefulWidget {
  const AdminHomes({super.key});

  @override
  State<AdminHomes> createState() => _AdminHomesState();
}
...
class _AdminHomesState extends State<AdminHomes> {
  int totalOrders = 0;
  int adminCount = 0;
  int marketerCount = 0;
  int dealerCount = 0;
