...
class TotalAdminSA extends StatefulWidget {
  const TotalAdminSA({super.key});

  @override
  State<TotalAdminSA> createState() => _TotalAdminSAState();
}

class _TotalAdminSAState extends State<TotalAdminSA> {
  ...
  Future<void> _fetchAdmins() async {
    ...
    final response = await AdminApiService.fetchAdmins();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer: SuperAdminDrawer(currentPage: "Admin Management"),
                ...
                if (!isTablet) ...[
                  ...
                  Padding(
                    ...
                    child: DropdownButton<String>(
                      isExpanded: true,
                      value: _selectedRole,
                      items: ['All Roles', 'SuperAdmin', 'Manager']
                          .map(
