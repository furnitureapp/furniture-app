...
class TotalMarketers extends StatelessWidget {
  const TotalMarketers({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: const SuperAdminDrawer(currentPage: "Total User Marketers"),
        ...
        child: Padding(
          ...
          child: DataTable(
            headingRowColor: MaterialStateColor.resolveWith(
                (states) => kPrimaryColor.withOpacity(0.2)),
            columnSpacing: 20,
            columns: const [
