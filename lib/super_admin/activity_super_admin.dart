...
class SuperAdActivitylog extends StatefulWidget {
  const SuperAdActivitylog({super.key});

  @override
  State<SuperAdActivitylog> createState() => _SuperAdActivitylogState();
}

class _SuperAdActivitylogState extends State<SuperAdActivitylog> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      drawer: const SuperAdminDrawer(currentPage: "Activity Log"),
