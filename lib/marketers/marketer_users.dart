...
class _DealersListPageState extends State<DealersListPage> {
      ...
      body: RefreshIndicator(
        ...
        child: LayoutBuilder(
          builder: (context, constraints) {
            // MOBILE: keep original ListView exactly as-is
            if (!isTablet) {
              return ListView(
            ...
            final double cardWidth =
                ...
                crossAxisCount;
            final double cardHeight = 350; // reasonable height for tablet cards
  ...
  InputDecoration _dropdownDecoration(String label) {
    return InputDecoration(
      labelText: label,
      labelStyle: GoogleFonts.poppins(fontSize: 12, color: mythemecolor),
              ...
              children: [
                ...
                Align(
                  ...
                  child: ElevatedButton.icon(
                    style: ElevatedButton.styleFrom(
                      backgroundColor: dealer['isActive'] == true
                          ? Colors.green
                          : Colors.red,
                    ...
                    onPressed: _updatingDealerId == dealer['_id']
                        ? null
                        : () async {
                            final newStatus = !(dealer['isActive'] ?? false);
                            ...
                            setState(() => _updatingDealerId = dealer['_id']);
                            ...
                            setState(() => _updatingDealerId = null);
                            ...
                            if (result['success']) {
                              setState(() => dealer['isActive'] = newStatus);
                            }
                          },
                  ),
                ),
...
// without ui updates but with filters
// import 'package:flutter/material.dart';
...
//               )
//             else
//               ...filteredDealers.map((dealer) => _dealerCard(dealer)).toList(),
//           ],
//         ),
//       ),
//     );
...
//             decoration: const BoxDecoration(
//               shape: BoxShape.circle,
//               gradient: LinearGradient(colors: [mythemecolor, mythemecolor1]),
//             ),
...
//                 _infoRow(Icons.phone, dealer['phoneNumber']),
//                 _infoRow(Icons.email_outlined, dealer['email']),
//                 _infoRow(Icons.badge_outlined, "GST: ${dealer['gstNumber']}"),
